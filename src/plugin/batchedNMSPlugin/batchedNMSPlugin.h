...
public:
    ...
    BatchedNMSPluginCustom(const std::string name, const void* data, size_t length);
    ...
    nvinfer1::DataType
         getOutputDataType(int index, const nvinfer1::DataType* inputType, int nbInputs) const PLUGIN_NOEXCEPT override;
...
class BatchedNMSPluginCustomCreator: public PluginCreatorBase<BatchedNMSPluginCustom> {
public:
