...
BatchedNMSPluginCustom::BatchedNMSPluginCustom(NMSParameters params): PluginDynamicBase(NMS_PLUGIN_NAME), param(params)
{
}

BatchedNMSPluginCustom::BatchedNMSPluginCustom(const std::string name, const void* data, size_t length):
...
int BatchedNMSPluginCustom::getNbOutputs() const PLUGIN_NOEXCEPT
{
    return 4;
}

nvinfer1::DimsExprs BatchedNMSPluginCustom::getOutputDimensions(int                        outputIndex,
...
size_t BatchedNMSPluginCustom::getWorkspaceSize(const nvinfer1::PluginTensorDesc* inputs,
                                                int                               nbInputs,
                                                ...
                                                int                               nbOutputs) const PLUGIN_NOEXCEPT
{
    ...
    return detectionInferenceWorkspaceSize(param.shareLocation,
                                           batch_size,
                                           boxes_size,
                                           score_size,
                                           param.numClasses,
...
void BatchedNMSPluginCustom::configurePlugin(const nvinfer1::DynamicPluginTensorDesc* inputs,
                                             int                                      nbInputs,
...
bool BatchedNMSPluginCustom::supportsFormatCombination(int                               pos,
...
nvinfer1::DataType BatchedNMSPluginCustom::getOutputDataType(int                       index,
...
void BatchedNMSPluginCustom::setClipParam(bool clip)
{
    mClipBoxes = clip;
}
...
const char* BatchedNMSPluginCustomCreator::getPluginName() const PLUGIN_NOEXCEPT
{
    return NMS_PLUGIN_NAME;
}

const char* BatchedNMSPluginCustomCreator::getPluginVersion() const PLUGIN_NOEXCEPT
{
    return NMS_PLUGIN_VERSION;
}

IPluginV2Ext* BatchedNMSPluginCustomCreator::createPlugin(const char*                  name,
