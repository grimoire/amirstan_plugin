...
public:
    ...
    TorchBmmPluginDynamic(const std::string name, const void* data, size_t length);
...
class TorchBmmPluginDynamicCreator: public PluginCreatorBase<TorchBmmPluginDynamic> {
public:
