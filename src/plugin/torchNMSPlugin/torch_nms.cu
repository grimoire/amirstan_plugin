...
namespace plugin
{
  ...
  void torch_nms(int *output, const T* bboxes, const T* scores,
    ...
    = {
      NMS_SCORE_KERNEL(1), NMS_SCORE_KERNEL(2), NMS_SCORE_KERNEL(3), NMS_SCORE_KERNEL(4), NMS_SCORE_KERNEL(5), NMS_SCORE_KERNEL(6), NMS_SCORE_KERNEL(7), NMS_SCORE_KERNEL(8),
    };
