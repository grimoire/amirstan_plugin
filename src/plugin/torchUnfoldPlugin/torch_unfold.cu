                  ...
                  cudaStream_t  stream)
{
    ...
    im2col_kernel<<<GET_BLOCKS(num_kernels), CUDA_NUM_THREADS, 0, stream>>>(num_kernels,
                                                                            input,
                                                                            height,
                                                                            width,
                                                                            kernel_height,
...
template void torch_unfold<float>(float*        output,
                                  const float*  input,
                                  const int64_t channels,
                                  const int64_t height,
                                  const int64_t width,
...
template void torch_unfold<int32_t>(int32_t*       output,
                                    const int32_t* input,
                                    const int64_t  channels,
                                    const int64_t  height,
                                    const int64_t  width,
