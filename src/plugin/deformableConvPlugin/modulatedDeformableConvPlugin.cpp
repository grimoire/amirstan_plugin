...
nvinfer1::IPluginV2DynamicExt* ModulatedDeformableConvPluginDynamic::clone() const PLUGIN_NOEXCEPT
{
    ModulatedDeformableConvPluginDynamic* plugin =
        new ModulatedDeformableConvPluginDynamic(mLayerName, mStride, mPadding, mDilation, mDeformableGroup, mGroup);
...
nvinfer1::DimsExprs
ModulatedDeformableConvPluginDynamic::getOutputDimensions(int                        outputIndex,
                                                              ...
                                                              int nbOutputs) const PLUGIN_NOEXCEPT
{
    ...
    size_t col_size =
        amirstan::common::getAlignedSize(nInputPlane * kW * kH * outputHeight * outputWidth * sizeof_dtype);
                                                  ...
                                                  cudaStream_t                      stream) PLUGIN_NOEXCEPT
{
    ...
    modulated_deform_conv_cuda_forward((float*)inputs[0],
                                       weight,
                                       bias,
                                       (float*)inputs[1],
                                       (float*)inputs[2],
...
// IPluginV2 Methods
const char* ModulatedDeformableConvPluginDynamic::getPluginType() const PLUGIN_NOEXCEPT
{
    return DCN_NAME;
}

const char* ModulatedDeformableConvPluginDynamic::getPluginVersion() const PLUGIN_NOEXCEPT
{
    return DCN_VERSION;
}
...
size_t ModulatedDeformableConvPluginDynamic::getSerializationSize() const PLUGIN_NOEXCEPT
{
    return sizeof(mStride) + sizeof(mPadding) + sizeof(mDilation) + sizeof(mDeformableGroup) + sizeof(mGroup);
}

void ModulatedDeformableConvPluginDynamic::serialize(void* buffer) const PLUGIN_NOEXCEPT
{
...
void ModulatedDeformableConvPluginDynamic::attachToContext(cudnnContext*            cudnnContext,
...
const char* ModulatedDeformableConvPluginDynamicCreator::getPluginName() const PLUGIN_NOEXCEPT
{
    return DCN_NAME;
}

const char* ModulatedDeformableConvPluginDynamicCreator::getPluginVersion() const PLUGIN_NOEXCEPT
{
    return DCN_VERSION;
}
...
IPluginV2* ModulatedDeformableConvPluginDynamicCreator::createPlugin(const char*                  name,
