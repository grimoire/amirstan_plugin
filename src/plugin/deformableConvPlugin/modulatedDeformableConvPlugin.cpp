...
void ModulatedDeformableConvPluginDynamic::setPaddingNd(
...
void ModulatedDeformableConvPluginDynamic::setDilationNd(
...
void ModulatedDeformableConvPluginDynamic::setDeformableGroup(
    int deformableGroup) {
...
nvinfer1::IPluginV2DynamicExt *ModulatedDeformableConvPluginDynamic::clone()
  ...
  ModulatedDeformableConvPluginDynamic *plugin =
      new ModulatedDeformableConvPluginDynamic(mLayerName, mType, mOutDim,
                                               mKernelSize, mW, mB);
...
int ModulatedDeformableConvPluginDynamic::enqueue(
  ...
  modulated_deform_conv_cuda_forward(
      ...
      (float *)inputs[2], (float *)outputs[0], workSpace, dcn_params, stream);
