                                         ...
                                         const void *const *inputs, void *const *outputs, void *workSpace, cudaStream_t stream)
{
    ...
    deform_conv_forward_cuda((float *)inputs[0], (float *)mWdev, (float *)mBdev, (float *)inputs[1],
...
IPluginV2 *DeformableConvPluginDynamicCreator::createPlugin(const char *name, const PluginFieldCollection *fc)
{
    ...
    DeformableConvPluginDynamic *plugin = new DeformableConvPluginDynamic(name, type, outDims, kernelSize, W, B);
    plugin->setPluginNamespace(getPluginNamespace());
