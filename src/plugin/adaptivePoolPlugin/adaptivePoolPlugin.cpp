...
AdaptivePoolPluginDynamic::AdaptivePoolPluginDynamic(const std::string&    name,
                                                     const nvinfer1::Dims& outputSize,
                                                     int                   poolingType):
    PluginDynamicBase(name), mOutputSize(outputSize), mPoolingType(poolingType)
{
}
...
nvinfer1::IPluginV2DynamicExt* AdaptivePoolPluginDynamic::clone() const PLUGIN_NOEXCEPT
{
    AdaptivePoolPluginDynamic* plugin = new AdaptivePoolPluginDynamic(mLayerName, mOutputSize, mPoolingType);
    plugin->setPluginNamespace(getPluginNamespace());

    return plugin;
}

nvinfer1::DimsExprs AdaptivePoolPluginDynamic::getOutputDimensions(int                        outputIndex,
...
bool AdaptivePoolPluginDynamic::supportsFormatCombination(int                               pos,
...
void AdaptivePoolPluginDynamic::configurePlugin(const nvinfer1::DynamicPluginTensorDesc* inputs,
                                                int                                      nbInputs,
...
size_t AdaptivePoolPluginDynamic::getWorkspaceSize(const nvinfer1::PluginTensorDesc* inputs,
                                                   int                               nbInputs,
...
int AdaptivePoolPluginDynamic::enqueue(const nvinfer1::PluginTensorDesc* inputDesc,
...
nvinfer1::DataType AdaptivePoolPluginDynamic::getOutputDataType(int                       index,
...
const char* AdaptivePoolPluginDynamic::getPluginVersion() const PLUGIN_NOEXCEPT
{
...
AdaptivePoolPluginDynamicCreator::AdaptivePoolPluginDynamicCreator()
{
    mPluginAttributes = std::vector<nvinfer1::PluginField>(
        {nvinfer1::PluginField("output_size"), nvinfer1::PluginField("pooling_type")});
    mFC.nbFields = mPluginAttributes.size();
    mFC.fields   = mPluginAttributes.data();
}

const char* AdaptivePoolPluginDynamicCreator::getPluginName() const PLUGIN_NOEXCEPT
{
    return PLUGIN_NAME;
}

const char* AdaptivePoolPluginDynamicCreator::getPluginVersion() const PLUGIN_NOEXCEPT
{
    return PLUGIN_VERSION;
}

IPluginV2* AdaptivePoolPluginDynamicCreator::createPlugin(const char*                  name,
                                                          const PluginFieldCollection* fc) PLUGIN_NOEXCEPT
{
    ...
    AdaptivePoolPluginDynamic* plugin = new AdaptivePoolPluginDynamic(name, outputSize, poolingType);
    plugin->setPluginNamespace(getPluginNamespace());
    return plugin;
}
}  // namespace plugin
