...
public:
    AdaptivePoolPluginDynamic(const std::string& name, const nvinfer1::Dims& outputSize, int poolingType);
...
class AdaptivePoolPluginDynamicCreator: public PluginCreatorBase<AdaptivePoolPluginDynamic> {
public:
