...
CarafeFeatureReassemblePluginDynamic::CarafeFeatureReassemblePluginDynamic(const std::string& name,
                                                                           int                scaleFactor,
                                                                           int                upKernel,
                                                                           int                upGroup):
    PluginDynamicBase(name), mScaleFactor(scaleFactor), mUpKernel(upKernel), mUpGroup(upGroup)
{
}
...
nvinfer1::IPluginV2DynamicExt* CarafeFeatureReassemblePluginDynamic::clone() const PLUGIN_NOEXCEPT
{
    CarafeFeatureReassemblePluginDynamic* plugin =
        new CarafeFeatureReassemblePluginDynamic(mLayerName, mScaleFactor, mUpKernel, mUpGroup);
    plugin->setPluginNamespace(getPluginNamespace());
    return plugin;
}

nvinfer1::DimsExprs
CarafeFeatureReassemblePluginDynamic::getOutputDimensions(int                        outputIndex,
                                                          ...
                                                          nvinfer1::IExprBuilder&    exprBuilder) PLUGIN_NOEXCEPT
{
    ...
    ret.d[2]          = exprBuilder.operation(nvinfer1::DimensionOperation::kPROD, *inputs[0].d[2], *kScaleFactor);

    ret.d[3] = exprBuilder.operation(nvinfer1::DimensionOperation::kPROD, *inputs[0].d[3], *kScaleFactor);

    return ret;
}

bool CarafeFeatureReassemblePluginDynamic::supportsFormatCombination(int                               pos,
...
void CarafeFeatureReassemblePluginDynamic::configurePlugin(const nvinfer1::DynamicPluginTensorDesc* inputs,
                                                           int                                      nbInputs,
...
size_t CarafeFeatureReassemblePluginDynamic::getWorkspaceSize(const nvinfer1::PluginTensorDesc* inputs,
                                                              int                               nbInputs,
                                                              ...
                                                              int nbOutputs) const PLUGIN_NOEXCEPT
{
    ...
    size_t rfeature_size =
        amirstan::common::getAlignedSize(batch_size * numChannel * inputHeight * inputWidth * sizeof_dtype);
    size_t rmask_size =
        amirstan::common::getAlignedSize(batch_size * maskChannel * outputHeight * outputWidth * sizeof_dtype);
    size_t routput_size =
        amirstan::common::getAlignedSize(batch_size * numChannel * outputHeight * outputWidth * sizeof_dtype);
    return rfeature_size + rmask_size + routput_size;
}

int CarafeFeatureReassemblePluginDynamic::enqueue(const nvinfer1::PluginTensorDesc* inputDesc,
                                                  ...
                                                  cudaStream_t                      stream) PLUGIN_NOEXCEPT
{
    ...
    CARAFEForwardLaucher((const float*)features,
                         (const float*)masks,
                         mUpKernel,
                         mUpGroup,
                         mScaleFactor,
...
nvinfer1::DataType CarafeFeatureReassemblePluginDynamic::getOutputDataType(int                       index,
...
// IPluginV2 Methods
const char* CarafeFeatureReassemblePluginDynamic::getPluginType() const PLUGIN_NOEXCEPT
{
    return PLUGIN_NAME;
}

const char* CarafeFeatureReassemblePluginDynamic::getPluginVersion() const PLUGIN_NOEXCEPT
{
...
size_t CarafeFeatureReassemblePluginDynamic::getSerializationSize() const PLUGIN_NOEXCEPT
{
    return sizeof(mScaleFactor) + sizeof(mUpKernel) + sizeof(mUpGroup);
}

void CarafeFeatureReassemblePluginDynamic::serialize(void* buffer) const PLUGIN_NOEXCEPT
{
...
{
    mPluginAttributes =
        std::vector<PluginField>({PluginField("scale_factor"), PluginField("up_kernel"), PluginField("up_group")});

    mFC.nbFields = mPluginAttributes.size();
    mFC.fields   = mPluginAttributes.data();
}

const char* CarafeFeatureReassemblePluginDynamicCreator::getPluginName() const PLUGIN_NOEXCEPT
{
    return PLUGIN_NAME;
}

const char* CarafeFeatureReassemblePluginDynamicCreator::getPluginVersion() const PLUGIN_NOEXCEPT
{
    return PLUGIN_VERSION;
}

IPluginV2* CarafeFeatureReassemblePluginDynamicCreator::createPlugin(const char*                  name,
                                                                     const PluginFieldCollection* fc) PLUGIN_NOEXCEPT
{
    ...
    CarafeFeatureReassemblePluginDynamic* plugin =
        new CarafeFeatureReassemblePluginDynamic(name, scaleFactor, upKernel, upGroup);
    plugin->setPluginNamespace(getPluginNamespace());
