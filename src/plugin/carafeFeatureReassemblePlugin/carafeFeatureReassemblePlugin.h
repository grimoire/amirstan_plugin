...
public:
    CarafeFeatureReassemblePluginDynamic(const std::string& name, int scaleFactor, int upKernel, int upGroup);
...
class CarafeFeatureReassemblePluginDynamicCreator: public PluginCreatorBase<CarafeFeatureReassemblePluginDynamic> {
public:
