...
public:
    DeformablePoolPluginDynamic(
        const std::string& name, const nvinfer1::Dims& outSize, float spatialScale, int samplingRatio, float gamma);

    DeformablePoolPluginDynamic(const std::string name, const void* data, size_t length);
...
class DeformablePoolPluginDynamicCreator: public PluginCreatorBase<DeformablePoolPluginDynamic> {
public:
