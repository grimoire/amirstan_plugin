...
DeformablePoolPluginDynamic::DeformablePoolPluginDynamic(
    const std::string& name, const nvinfer1::Dims& outSize, float spatialScale, int samplingRatio, float gamma):
...
nvinfer1::IPluginV2DynamicExt* DeformablePoolPluginDynamic::clone() const PLUGIN_NOEXCEPT
{
    DeformablePoolPluginDynamic* plugin =
        new DeformablePoolPluginDynamic(mLayerName, mOutSize, mSpatialScale, mSamplingRatio, mGamma);
...
nvinfer1::DimsExprs
DeformablePoolPluginDynamic::getOutputDimensions(int                        outputIndex,
...
bool DeformablePoolPluginDynamic::supportsFormatCombination(int                               pos,
...
void DeformablePoolPluginDynamic::configurePlugin(const nvinfer1::DynamicPluginTensorDesc* inputs,
                                                  int                                      nbInputs,
...
size_t DeformablePoolPluginDynamic::getWorkspaceSize(const nvinfer1::PluginTensorDesc* inputs,
                                                     int                               nbInputs,
...
int DeformablePoolPluginDynamic::enqueue(const nvinfer1::PluginTensorDesc* inputDesc,
...
nvinfer1::DataType DeformablePoolPluginDynamic::getOutputDataType(int                       index,
...
const char* DeformablePoolPluginDynamic::getPluginVersion() const PLUGIN_NOEXCEPT
{
...
size_t DeformablePoolPluginDynamic::getSerializationSize() const PLUGIN_NOEXCEPT
{
    return sizeof(mOutSize) + sizeof(mSpatialScale) + sizeof(mSamplingRatio) + sizeof(mGamma);
}

void DeformablePoolPluginDynamic::serialize(void* buffer) const PLUGIN_NOEXCEPT
{
...
DeformablePoolPluginDynamicCreator::DeformablePoolPluginDynamicCreator()
{
    mPluginAttributes = std::vector<PluginField>(
        {PluginField("out_size"), PluginField("spatial_scale"), PluginField("sampling_ratio"), PluginField("gamma")});
    mFC.nbFields = mPluginAttributes.size();
    mFC.fields   = mPluginAttributes.data();
}

const char* DeformablePoolPluginDynamicCreator::getPluginName() const PLUGIN_NOEXCEPT
{
    return PLUGIN_NAME;
}

const char* DeformablePoolPluginDynamicCreator::getPluginVersion() const PLUGIN_NOEXCEPT
{
    return PLUGIN_VERSION;
}

IPluginV2* DeformablePoolPluginDynamicCreator::createPlugin(const char*                  name,
                                                            const PluginFieldCollection* fc) PLUGIN_NOEXCEPT
{
    ...
    DeformablePoolPluginDynamic* plugin =
        new DeformablePoolPluginDynamic(name, outSize, spatialScale, samplingRatio, gamma);
    plugin->setPluginNamespace(getPluginNamespace());
    return plugin;
}
