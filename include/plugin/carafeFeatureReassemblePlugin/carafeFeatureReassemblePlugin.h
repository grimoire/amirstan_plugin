...
class CarafeFeatureReassemblePluginDynamic : public nvinfer1::IPluginV2DynamicExt
{
public:
    CarafeFeatureReassemblePluginDynamic(
        const std::string &name,
        int scaleFactor, int upKernel, int upGroup);

    CarafeFeatureReassemblePluginDynamic(const std::string name, const void *data, size_t length);

    // It doesn't make sense to make CarafeFeatureReassemblePluginDynamic without arguments, so we
...
class CarafeFeatureReassemblePluginDynamicCreator : public nvinfer1::IPluginCreator
{
public:
