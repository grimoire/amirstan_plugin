...
class GridSamplePluginDynamic : public nvinfer1::IPluginV2DynamicExt
{
public:
    GridSamplePluginDynamic(
        const std::string &name,
        int mode, int paddingMode, bool alignCorners);

    GridSamplePluginDynamic(const std::string name, const void *data, size_t length);

    // It doesn't make sense to make GridSamplePluginDynamic without arguments, so we
...
class GridSamplePluginDynamicCreator : public nvinfer1::IPluginCreator
{
public:
